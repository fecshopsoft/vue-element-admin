<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input clearable @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" :placeholder="$t('table.market_group_name')" v-model="listQuery.name">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column min-width="100px" align="left" :label="$t('table.market_group_name')">
        <template slot-scope="scope">
...
<script>
// 从api包中导入用于ajax的函数
import { fetchList, createOne, updateOne, deleteOne, batchDelete } from '@/api/common/marketgroup'
