  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-select clearable class="filter-item" style="width: 180px" v-model="listQuery.fec_design" :placeholder="$t('table.fec_design')">
        <el-option v-for="item in  designSelectOps" :key="item.key" :label="item.display_name" :value="item.key">
        </el-option>
      </el-select>
...
<script>
// 从api包中导入用于ajax的函数
import { fetchList, fetchTrendInfo } from '@/api/adsdetailstics/imager'
  ...
  data() {
    return {
      ...
      listQuery: { // 当前的查询参数值
        ...
        // id: undefined
        fec_design: undefined, // 按照username搜索
        own_id: undefined,
