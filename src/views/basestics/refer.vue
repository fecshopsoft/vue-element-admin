<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table height="650" :default-sort = "{ prop: listQuery.sort, order: listQuery.sort_dir }"  @sort-change="sortChange" stripe :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      -->
      <el-table-column sortable="custom" prop="first_referrer_domain" fixed show-overflow-tooltip  width="110px" align="left" :label="$t('table.first_referrer_domain')">
        <template slot-scope="scope">
...
<script>
// 从api包中导入用于ajax的函数
import { fetchList, fetchTrendInfo } from '@/api/basestics/refer'
  ...
  data() {
    return {
      ...
      listQuery: { // 当前的查询参数值
        ...
        // id: undefined
        first_referrer_domain: undefined, // 按照username搜索
